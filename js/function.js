...
$(function () {
	...
	$("#content").css("height", Math.max($loveHeart.height(), 0));
...
function showDateTime() {
	...
	together = new Date("6/18/2019 01:00:00");
	today = new Date();
	timeold = (today.getTime() - together.getTime());
	...
	var result = "<span class=\"digit\">" + daysold + "</span> 天 <span class=\"digit\">" + formartZero(hrsold) + 
	"</span> 小时 <span class=\"digit\">" + formartZero(minsold) + "</span> 分钟 <span class=\"digit\">" + formartZero(seconds) + "</span> 秒";
	$('#elapseClock').html(result);
}
